...
def generate_enhanced_pr_body(original_body: str, screenshots: list, dump_data: dict):
    ...
    if dump_data and dump_data.get('credentials'):
        body_parts.extend([
            ...
            "",
            f"⚠️ **{len(dump_data['credentials'])} credential entries found in database dump**",
            "",
            "<details>",
    ...
    body_parts.extend([
        ...
        "1. 🔍 **Review** - Carefully review all code changes in this PR",
        "2. 🧪 **Test** - Run your test suite to ensure patches don't break functionality",
        "3. 🔒 **Deploy** - Merge and deploy ASAP to close the vulnerability",
        "4. 🔑 **Rotate** - Change all credentials that may have been exposed",
        "5. 📊 **Audit** - Check logs for signs of exploitation",
        "",
        "### 🎯 Attack Vector:",
        ...
        "---",
        "",
        "🤖 **Generated by AutoCTF** - Autonomous Pentesting & Patching Agent",
        "",
